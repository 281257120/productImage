 ...
 * @LastEditTime: 2024-05-13 10:51:41
 * @LastEditors: Liu Yang
 * @Description:
 * @FilePath: \drag-demo\src\pages\dynamic-render\recursive-list\work-bench\Index.vue
-->
<template>
...
console.log(store.system.useLayoutStore())
