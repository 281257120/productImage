 ...
 * @LastEditTime: 2024-05-15 14:05:19
 * @LastEditors: Liu Yang
 * @Description:
 * @FilePath: \drag-demo\src\config\theme\light.ts
 */
/*
 * @Author: zouyaoji@https://github.com/zouyaoji
 * @Date: 2022-05-28 17:42:33
...
export const themeLight = {
  ...
  global: {
    ...
    themeQMenuColor: '#fff',
    themeQMenuBackgroundColor: 'rgba(0,229,255, 0.5)',
    themeQCardColor: '#fff',
    themeQCardHeaderBackgroundColor: 'rgba(0,229,255, 0.5)',
    themeQCardBackgroundColor: 'rgba(0,229,255, 0.5)',
  ...
  header: {
     ...
     * 标题第二层(内容区域)背景颜色
     */
    themeHeaderContentBackgroundColor: 'rgba(255, 255, 255, 1)'
  },
  commonPanel: {
    /**
