 ...
 * @LastEditTime: 2024-05-14 10:13:37
 * @FilePath: \drag-demo\src\store\system\theme.ts
...
import { themeClassic as classic, themeElement as element, themeLight as light } from '@src/config/theme'
...
export const useThemeStore = defineStore('theme', {
  ...
  actions: {
    ...
    async set(themeName) {
      ...
      //改变element-ui主题
      this.changeElementStyleTheme(this.activeName)
    },
    /**
    ...
    //动态更改html标签的class
    changeElementStyleTheme(name: string) {
      if (name == 'light') {
