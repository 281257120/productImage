 ...
 * @LastEditTime: 2024-05-15 13:41:39
 * @LastEditors: Liu Yang
 * @Description:
 * @FilePath: \drag-demo\src\layouts\header\Index.vue
-->
<template>
  <div class="main-header">
    ...
    <div class="menu-container">
      <q-tabs v-model:model-value="selectedTab" align="left" indicator-color="cyan-13"
        @update:model-value.once="onUpdateSelectedTab">
        <q-route-tab v-for="(menu, index) in headerMenus" :key="index" :name="menu.name" :to="menu.path" exact
          :label="menu.caption" content-class="menu-tab" active-class="menu-active" />
      </q-tabs>
    </div>
    <!-- <q-space></q-space> -->
